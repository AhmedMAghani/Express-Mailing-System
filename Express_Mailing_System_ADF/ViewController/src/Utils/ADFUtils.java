...
public class ADFUtils {
    ...
    public static final ADFLogger LOGGER = ADFLogger.createADFLogger(Utils.ADFUtils.class);
    ...
    */
    ...
    /**
     * this finction navigate using taskflow rout
     * @param route
     */
    public static void navigateTo(String route){
        FacesContext.getCurrentInstance().getApplication().getNavigationHandler().handleNavigation(FacesContext.getCurrentInstance(), null, route);
    }
}
